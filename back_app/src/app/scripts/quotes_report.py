...
DEC18 = Decimal(10 ** 18)
columns = ['Chain', 'Symbol', 'Quote id', 'Account', 'Quote status', 'Ordered time', 'Open time', 'Updated time',
           'Liquidated time', 'Closed time', 'Open duration', 'Funding rate fees paid', 'Platform fees paid',
           'Locked collateral', 'Leverage', 'Direction', 'Order type', 'Open size', 'Close size', 'Open price',
           'Open price after funding', 'Close price', 'Market price', 'Open quantity', 'Close quantity',
            ...
            for quote in quotes:
                ...
                pl_usdGross_realized = (1 if quote.positionType == 0 else -1) * (
                        (Decimal(quote.averageClosedPrice or 0) - Decimal(quote.initialOpenedPrice or 0)) / DEC18) * (
                                               Decimal(quote.quantity) / DEC18) - Decimal(
                    quote.userPaidFunding) / DEC18 - (
