...
from src.app.generated_response_models import AffiliateSnapshotModel, HedgerSnapshotModel, LiquidatorSnapshotModel, HedgerBinanceSnapshotModel
from src.app.models import AffiliateSnapshot, HedgerSnapshot, LiquidatorSnapshot, HedgerBinanceSnapshot
...
async def get_hedger_snapshot(
    ...
    query = (
        ...
        .where(
            and_(eq(HedgerSnapshot.tenant, tenant), eq(HedgerSnapshot.name, hedger)),
        )
