...
from src.app import log_span_context, LogTransaction
...
from src.services.snapshot.affiliate_snapshot import prepare_affiliate_snapshot
from src.services.snapshot.hedger_binance_snapshot import prepare_hedger_binance_snapshot
from src.services.snapshot.hedger_snapshot import prepare_hedger_snapshot
from src.services.snapshot.liquidator_snapshot import prepare_liquidator_snapshot
...
async def sync_data(context, session, transaction_id):
    ...
    with log_span_context(session, "Sync Data With Subgraph", transaction_id) as log_span:
        ...
        try:
            ...
            subgraph_client.sync(session, sync_block, transaction_id, [User, Symbol])
