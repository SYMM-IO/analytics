...
def upgrade() -> None:
    ...
    op.create_table('affiliate_snapshot',
    ...
    sa.Column('liquidated_notional_value', sa.Numeric(precision=40, scale=0), nullable=True),
    ...
    sa.Column('hedger_contract_allocated', sa.Numeric(precision=40, scale=0), nullable=True),
    ...
    op.create_table('binance_income',
    ...
    op.create_table('hedger_snapshot',
    ...
    sa.Column('paid_funding_rate', sa.Numeric(precision=40, scale=0), nullable=True),
    sa.Column('received_funding_rate', sa.Numeric(precision=40, scale=0), nullable=True),
    sa.Column('next_funding_rate', sa.Numeric(precision=40, scale=0), nullable=True),
