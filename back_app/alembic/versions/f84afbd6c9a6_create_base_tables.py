...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("openTradeVolume", sa.Numeric(precision=40, scale=0), nullable=True),
        sa.Column("closeTradeVolume", sa.Numeric(precision=40, scale=0), nullable=True),
        sa.Column("liquidateTradeVolume", sa.Numeric(precision=40, scale=0), nullable=True),
        ...
        sa.Column("averagePositionSize", sa.Numeric(precision=40, scale=0), nullable=True),
        sa.Column("positionsCount", sa.Numeric(precision=40, scale=0), nullable=True),
        sa.Column("updateTimestamp", sa.DateTime(), nullable=True),
        sa.Column("timestamp", sa.DateTime(), nullable=False),
        sa.Column("tenant", sa.String(), nullable=False),
        sa.PrimaryKeyConstraint("timestamp", "accountSource"),
    )
    op.create_table(
        "weekly_history",
        sa.Column("id", sa.String(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("timestamp", sa.DateTime(), nullable=False),
        sa.Column("tenant", sa.String(), nullable=False),
        sa.PrimaryKeyConstraint("timestamp", "accountSource", "solver"),
    )
    op.create_table(
        "total_history",
        sa.Column("accountSource", sa.String(), nullable=False),
        sa.Column("collateral", sa.String(), nullable=False),
        sa.Column("tradeVolume", sa.Numeric(precision=40, scale=0)),
        sa.Column("openTradeVolume", sa.Numeric(precision=40, scale=0)),
        sa.Column("closeTradeVolume", sa.Numeric(precision=40, scale=0)),
        sa.Column("liquidateTradeVolume", sa.Numeric(precision=40, scale=0)),
        sa.Column("deposit", sa.Numeric(precision=40, scale=0)),
        sa.Column("withdraw", sa.Numeric(precision=40, scale=0)),
        sa.Column("allocate", sa.Numeric(precision=40, scale=0)),
        sa.Column("deallocate", sa.Numeric(precision=40, scale=0)),
        sa.Column("platformFee", sa.Numeric(precision=40, scale=0)),
        sa.Column("fundingPaid", sa.Numeric(precision=40, scale=0)),
        sa.Column("fundingReceived", sa.Numeric(precision=40, scale=0)),
        sa.Column("accounts", sa.Integer()),
        sa.Column("users", sa.Integer()),
        sa.Column("quotesCount", sa.Integer()),
        sa.Column("updateTimestamp", sa.DateTime()),
        sa.Column("timestamp", sa.DateTime()),
        sa.PrimaryKeyConstraint("accountSource", "collateral"),
    )
    op.create_table(
        "hedger_snapshot",
...
def downgrade() -> None:
    ...
    op.drop_table("total_history")
    op.drop_table("solver_daily_history")
