...
def create_schedular():
    global scheduler
    scheduler = BackgroundScheduler()
    scheduler.add_job(func=load_stats_messages, trigger="interval", seconds=fetch_data_interval)
    ...
    scheduler.add_job(func=update_binance_deposit_v2, trigger="interval", seconds=update_binance_deposit_interval)
